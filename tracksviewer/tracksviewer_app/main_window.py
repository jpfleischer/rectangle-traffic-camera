...
from tracksviewer_app.constants import (
    APP_ORG, APP_NAME,
    SETTINGS_LAST_TIF, SETTINGS_MP4_DIR,
...
class TracksPlayer(QtWidgets.QMainWindow):
    ...
    def _refresh_brake_table_from_cache(self):
        ...
        try:
            ...
            for i, row in enumerate(rows):
                ...
                base_ts = get_video_base_timestamp(self.ch, self._video_base_ts_cache, video) if self.ch else None
    ...
    def jump_to_braking_event(self, ev: dict):
        ...
        base_ts = get_video_base_timestamp(self.ch, self._video_base_ts_cache, video)
        if base_ts is None:
